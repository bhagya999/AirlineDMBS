...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2018 at 05:01 AM
...
--
ALTER TABLE `booking`
  MODIFY `booking_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `passenger`
  MODIFY `ticket_no` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
